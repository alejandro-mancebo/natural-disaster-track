...
export const MapComponent = ({ selectMyLocation }: Props) => {
  ...
  const [markerList, setMarkerList] = useState(initialMarkerList);
  ...
  const created = (e: any) => {
    ...
    const coordinates: MarkerCoords['coordinates'] = [e.layer._latlng.lat, e.layer._latlng.lng];
    setNewMarker({ _id: id, coordinates: coordinates });
  }
